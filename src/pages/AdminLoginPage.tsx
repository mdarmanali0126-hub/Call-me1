    ...
    try {
      ...
      if (loggedUser.email?.toLowerCase() !== 'mdarmanali0126@gmail.com') {
        setErrorDetails({
          ...
          message: `Signed in as ${loggedUser.email}, but this account is not recognized as the authorized administrator. Please choose the correct administrator account.`,
